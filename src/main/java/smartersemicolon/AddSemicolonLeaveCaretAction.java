...
public class AddSemicolonLeaveCaretAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        WriteCommandAction.runWriteCommandAction(project, () -> {
            ...
            // Check if the last character of the line is not a semicolon
            if (!lineText.endsWith(";")) {
                // Insert the semicolon at the end of the line
                document.insertString(lineEndOffset, ";");
            }

            // No need to move the caret; it remains in its original position
        });
    }
}
